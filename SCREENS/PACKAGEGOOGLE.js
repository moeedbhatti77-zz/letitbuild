...
const PACKAGE = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.Container}>
      <Header style={{ backgroundColor: "#48d1cc", marginTop: 35 }}>
      ...
      <View>
        <Card style={styles.Card}>
          <TouchableOpacity onPress={() => saveItem(em)}>
            <ImageBackground
              source={{
        ...
        <Card style={styles.Card}>
          <TouchableOpacity onPress={() => saveItem1(em)}>
            <ImageBackground
              source={{
        ...
        <Card style={styles.Card}>
          <TouchableOpacity onPress={() => saveItem2(em)}>
            <ImageBackground
              source={{
      ...
      <TouchableOpacity
        style={{ bottom: 60 }}
        onPress={() => navigation.navigate("PAYMENTGOOGLE", { mail: em })}
      >
        <Image
          source={{
